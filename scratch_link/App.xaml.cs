...
namespace scratch_link
{
    ...
    public partial class App
    {
        ...
        private static class SDMPath
        {
            ...
            public const string HC = "/scratch/hc";
        }

        private readonly NotifyIcon _icon;
        private readonly WebSocketServer _server;
        private readonly WebSocketServer _server2;
        private readonly SortedDictionary<string, SessionManager> _sessionManagers;

        private App()
        {
            var appAssembly = typeof(App).Assembly;
            var simpleVersionString = "1.0";// $"{scratch_link.Properties.Resources.AppTitle} {appAssembly.GetName().Version}";
            ...
            _sessionManagers = new SortedDictionary<string, SessionManager>
            {
                ...
                [SDMPath.HC] = new SessionManager(webSocket => new HC06Session(webSocket))
            };
            ...
            _server2 = new WebSocketServer($"ws://0.0.0.0:55")
            {
                RestartAfterListenError = true
            };
            try
        ...
        {
            _sessionManagers[SDMPath.BLE].Close();
            _sessionManagers[SDMPath.BT].Close();
            _sessionManagers[SDMPath.HC].Close();
            _icon.Visible = false;
            _server.Dispose();
        }
