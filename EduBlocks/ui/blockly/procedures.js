 ...
 * @readonly
 */
var CUSTOM_CONTEXT_MENU_VARIABLE_GETTER_SETTER_MIXIN = {
  /**
...
/**
  ...
  */
var RENAME_OPTION_CALLBACK_FACTORY = function(block) {
  return function() {
 ...
 */
var DELETE_OPTION_CALLBACK_FACTORY = function(block) {
  return function() {
    var workspace = block.workspace;
    var variable = block.getField('VAR').getVariable();
